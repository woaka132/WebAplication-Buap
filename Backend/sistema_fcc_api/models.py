...
class Alumnos(models.Model):
    ...
    def __str__(self):
        return "Perfil del alumnos "+self.first_name+" "+self.last_name
...
class Maestros(models.Model):
    ...
    edad = models.IntegerField(null=True, blank=True)
    ocupacion = models.CharField(max_length=255,null=True, blank=True)
    areas_de_trabajo = models.CharField(max_length=255,null=True, blank=True)
...
class Materia(models.Model):
    ...
    nombre_de_la_materia = models.CharField(max_length=255, null=True, blank=True)
    seccion = models.CharField(max_length=255, null=True, blank=True)
    dias_json = models.TextField(null=True, blank=True)
    horario_inicio = models.CharField(max_length=255,null=True, blank=True)
    horario_finalizacion = models.CharField(max_length=255,null=True, blank=True)
